...
from probik_demo.ptf_utils import quaternion_from_rpy, quaternion_msg_from_wxyz, vector3_msg_from_array
...
def _candidate_from_dict(candidate_dict):
    ...
    if "object_to_grasp_orientation_wxyz" in candidate_dict:
    ...
    candidate.approach_axis = vector3_msg_from_array(candidate_dict.get("approach_axis", [1.0, 0.0, 0.0]))
    candidate.finger_axis = vector3_msg_from_array(candidate_dict.get("finger_axis", [0.0, 1.0, 0.0]))
